...
def main():
    ...
    print ("dir =/n", in_arg.dir, "/n arch=", in_arg.arch, "/n dogfile =", in_arg.dogfile) 
    # TODO: 3. Define get_pet_labels() function to create pet image labels by
    # creating a dictionary with key=filename and value=file label to be used
    # to check the accuracy of the classifier function
    answers_dic = get_pet_labels(in_arg.dir)
    # temporary cod to print 10 key-value paris & makes sure there are 40 pairs
    # one for each fiel in pet_images
    
    #Function that checks Pet Image sDictionary - answers_dic
...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           # uses split ot extract wrods of filename into list image_name
